...
do
    ...
    python init_base_model.py --arch ${ARCH} --train_epoch 50 --train_data_name wilds_camelyon17 --lr 0.001 --batch_size 128 --corruption 0 --seed 123 --gpu ${gpu} --cifar_data_path /data/home/czxie --cifar_corruption_path /data/home/czxie
    python init_base_model.py --arch ${ARCH} --train_epoch 50 --train_data_name entity13 --lr 0.001 --batch_size 128 --seed 123 --gpu ${gpu} --cifar_data_path /data/DS1618p/Image__ILSVRC2012 --cifar_corruption_path /data/czxie/imagenet-c
    python init_base_model.py --arch ${ARCH} --train_epoch 50 --train_data_name entity30 --lr 0.001 --batch_size 128 --seed 123 --gpu ${gpu}  --cifar_data_path /data/DS1618p/Image__ILSVRC2012 --cifar_corruption_path /data/czxie/imagenet-c
    python init_base_model.py --arch ${ARCH} --train_epoch 50 --train_data_name living17 --lr 0.001 --batch_size 128 --seed 123 --gpu ${gpu}  --cifar_data_path /data/DS1618p/Image__ILSVRC2012 --cifar_corruption_path /data/czxie/imagenet-c
    python init_base_model.py --arch ${ARCH} --train_epoch 50 --train_data_name nonliving26 --lr 0.001 --batch_size 128 --seed 123 --gpu ${gpu}  --cifar_data_path /data/DS1618p/Image__ILSVRC2012 --cifar_corruption_path /data/czxie/imagenet-c
done
